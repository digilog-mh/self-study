...
public class QMovie extends EntityPathBase<Movie> {
    ...
    private static final long serialVersionUID = 1586116118L;
    ...
    //inherited
    public final ListPath<japbook.jpashop.domain.Category, japbook.jpashop.domain.QCategory> categories = _super.categories;
